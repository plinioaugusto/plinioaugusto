...
[![Seguidores no GitHub](https://img.shields.io/github/followers/plinioaugusto?style=flat-square&label=Seguidores)](https://github.com/plinioaugusto)
  ...
  <table>
    <tr>
      <td width="33%" align="center">
        <img src="./.github/assets/work/1.png" width="100%" alt="Recebimento do Prêmio Melhores do Ano 2023 na categoria back-end" />
        <br />
        <sub><b>Prêmio Melhores do Ano 2023 - Back-end</b></sub>
      </td>
      <td width="33%" align="center">
        <img src="./.github/assets/work/2.png" width="100%" alt="Algumas das premiações recebidas" />
        <br />
        <sub><b>Algumas das premiações recebidas</b></sub>
      </td>
      <td width="33%" align="center">
        <img src="./.github/assets/work/3.png" width="100%" alt="Trabalho no dia a dia" />
        <br />
        <sub><b>Trabalho no dia a dia</b></sub>
      </td>
    </tr>
  </table>
  <table>
    <tr>
      <td width="50%" align="center">
        <img src="./.github/assets/work/4.png" width="100%" alt="Reunião de tech leaders 2026-2" />
        <br />
        <sub><b>Reunião de tech leaders 2026-2</b></sub>
      </td>
      <td width="50%" align="center">
        <img src="./.github/assets/work/5.png" width="100%" alt="Estação de trabalho para desenvolvimento" />
        <br />
        <sub><b>Estação de trabalho - Setup</b></sub>
      </td>
    </tr>
  </table>
</div>
...
<div align="center">
  <img src="https://skillicons.dev/icons?i=java,nodejs,ts,js,express,postgres,mysql,mongodb,redis,kafka,docker,jest,git,github,linux" alt="Java, Node.js, TypeScript, JavaScript, Express, PostgreSQL, MySQL, MongoDB, Redis, Kafka, Docker, Jest, Git, GitHub e Linux" />
</div>
